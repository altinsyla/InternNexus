  ...
  return (
    <div>
          ...
          <tbody>
            {internships.map((internship) => (
              <tr key={internship._id}>
                ...
                <td>{new Date(internship.registeredDate).toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}</td>
      ...
      >
        ...
        >
          <Modal.Title id="example-modal-sizes-title-lg">Internship</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <form className="modalform" onSubmit={handleSubmit} encType="multipart/form-data">
